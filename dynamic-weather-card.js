...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},u=Ko(wa),f=Ko(lo),nn=Ko(so),Q=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),di=new WeakMap,B=$.createTreeWalker($,129),C=co;function ei(o,i){if(!Ao(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`;class ji extends M{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ko;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=ho(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
    ...
    `}}p([m({type:Array})],Di.prototype,"forecast",void 0),p([m({type:String})],Di.prototype,"lang",void 0);customElements.define("daily-forecast",Di);class Vo extends M{animationManager;forecastService;actionHandler;subscribedEntity=null;subscribedShowDaily=!1;_testTimeOfDay;static get styles(){return Qi}static getConfigElement(){return document.createElement("dynamic-weather-card-editor")}static getStubConfig(){return{type:"custom:dynamic-weather-card",entity:"weather.home",show_hourly_forecast:!0,hourly_forecast_hours:e.hourlyForecastHours,show_daily_forecast:!0,daily_forecast_days:e.dailyForecastDays}}constructor(){super();this.config={},this.animationManager=new Po(()=>this.getDrawParams()),this.forecastService=new Go(()=>this.requestUpdate()),this.actionHandler=new jo(()=>this.hass,()=>this.config,(o,i)=>this.fireEvent(o,i))}connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{setTimeout(()=>{let o=this.shadowRoot?.querySelector(".canvas-container");if(o)this.animationManager.setup(o)},100)})}disconnectedCallback(){super.disconnectedCallback(),this.animationManager.destroy(),this.forecastService.unsubscribe()}updated(o){if(super.updated(o),o.has("hass")||o.has("config")){let a=this.config.entity,n=this.config.showDailyForecast??!1;if(this.hass&&a&&(a!==this.subscribedEntity||n!==this.subscribedShowDaily))this.subscribedEntity=a,this.subscribedShowDaily=n,this.forecastService.subscribe(this.hass,a,n)}let i=I({configLang:this.config?.language,hassLang:this.hass?.language});if(_.lang!==i)_.setLanguage(i)}getDrawParams(){if(!this.hass||!this.config.entity)return null;let o=To(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),i=this.hass.states[this.config.entity],a=So(i||{},this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||xo(a);return{condition:o.condition,timeOfDay:n}}getDetailsConfig(){return{showHumidity:this.config.showHumidity??!0,showWind:this.config.showWind??!0,showWindGust:this.config.showWindGust??!0,showWindDirection:this.config.showWindDirection??!0,showSunriseSunset:this.config.showSunriseSunset??!0,clockFormat:this.config.clockFormat??"24h",windSpeedUnit:this.config.windSpeedUnit??"ms"}}setConfig(o){if(!o.entity)throw Error("Please define a weather entity");let i=o.show_hourly_forecast??o.show_forecast;if(this.config={type:"custom:dynamic-weather-card",entity:o.entity,icons_path:o.icons_path,name:o.name,height:o.height||e.height,showFeelsLike:o.show_feels_like!==!1,showWind:o.show_wind!==!1,showWindGust:o.show_wind_gust!==!1,showWindDirection:o.show_wind_direction!==!1,showHumidity:o.show_humidity!==!1,showMinTemp:o.show_min_temp!==!1,showForecast:o.show_forecast===!0,showHourlyForecast:i===!0,showDailyForecast:o.show_daily_forecast===!0,hourlyForecastHours:o.hourly_forecast_hours??e.hourlyForecastHours,dailyForecastDays:o.daily_forecast_days??e.dailyForecastDays,showSunriseSunset:o.show_sunrise_sunset!==!1,showClock:o.show_clock===!0,clockPosition:o.clock_position||e.clockPosition,clockFormat:o.clock_format||e.clockFormat,overlayOpacity:o.overlay_opacity!==void 0?o.overlay_opacity:e.overlayOpacity,language:o.language||e.language,windSpeedUnit:o.wind_speed_unit||e.windSpeedUnit,sunriseEntity:o.sunrise_entity||null,sunsetEntity:o.sunset_entity||null,templowAttribute:o.templow_attribute||null,tapAction:o.tap_action||{action:"more-info"},holdAction:o.hold_action||{action:"none"},doubleTapAction:o.double_tap_action||{action:"none"}},this.config.language)_.setLanguage(this.config.language)}fireEvent(o,i={}){let a=new CustomEvent(o,{detail:i,bubbles:!0,composed:!0});this.dispatchEvent(a)}getCardSize(){return 1}render(){if(!this.hass)return u`<div>No Home Assistant connection</div>`;let o=To(this.hass,this.config.entity,this.config,this.forecastService.getHourlyData()),i=this.hass.states[this.config.entity],a=So(i,this.config.sunriseEntity,this.config.sunsetEntity,this.hass),n=this._testTimeOfDay||xo(a),l=`weather-card ${n.type}`,s=this.config.height?`${this.config.height}px`:"200px",r=Ji(n),c=r?`background: linear-gradient(135deg, rgb(${r.start.r}, ${r.start.g}, ${r.start.b}), rgb(${r.end.r}, ${r.end.g}, ${r.end.b}));`:"",g=`--overlay-opacity: ${this.config.overlayOpacity!==void 0?this.config.overlayOpacity:e.overlayOpacity};`,h=this.config.showHourlyForecast?this.forecastService.getHourlyForecast(this.config.hourlyForecastHours??e.hourlyForecastHours,o):[],y=this.config.showDailyForecast?this.forecastService.getDailyForecast(this.config.dailyForecastDays??e.dailyForecastDays,o):[];return u`
      <ha-card
        @click=${(t)=>this.actionHandler.handleTap(t)}
        @pointerdown=${()=>this.actionHandler.handlePointerDown()}
        @pointerup=${(t)=>this.actionHandler.handlePointerUp(t)}
        @pointercancel=${(t)=>this.actionHandler.handlePointerUp(t)}
      >
