...
\f\r]`,ka=`[^ 	
\f\r"'\`<>=]`,ua=`[^\\s"'>=/]`,T=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ni=1,mo=2,ya=3,li=/-->/g,si=/>/g,W=new RegExp(`>|${po}(?:(${ua}+)(${po}*=${po}*(?:${ka}|("|')|))|$)`,"g"),fa=0,ri=1,wa=2,ci=3,Fo=/'/g,Mo=/"/g,hi=/^(?:script|style|textarea|title)$/i,ta=1,lo=2,so=3,Ho=1,ro=2,pa=3,ma=4,Fa=5,bo=6,Ma=7,Ko=(o)=>(i,...a)=>{if(i.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
`,Da={sunny:f`
  ...
  `};function E(o,...i){let a=Ta[o];if(typeof a==="function")return a(...i);return a||""}function eo(o){if(!o)return"";return Da[o.toLowerCase()]||""}class Gi extends M{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=J`
    :host {
      display: block;
    }
