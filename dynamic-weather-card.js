...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},u=Ko(ta),f=Ko(so),nn=Ko(ro),Q=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),di=new WeakMap,B=$.createTreeWalker($,129),C=_o;function ei(o,i){if(!Ao(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,Ta={sunny:f`
  ...
  `};function E(o,...i){let a=Da[o];if(typeof a==="function")return a(...i);return a||""}function oo(o){if(!o)return"";return Ta[o.toLowerCase()]||""}class Gi extends M{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=J`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return u``;return u`
    ...
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return u``;let o=this.entityAttributes||{},i=qo(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Bi(o,this.config.windSpeedUnit,_.t.bind(_)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${qo(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Pi(this.weather.windBearing):E("wind");return u`
      <div class="info-item">
    ...
    `}}p([m({type:Object})],Gi.prototype,"weather",void 0),p([m({type:Object})],Gi.prototype,"sunData",void 0),p([m({type:Object})],Gi.prototype,"config",void 0),p([m({type:Object})],Gi.prototype,"entityAttributes",void 0);customElements.define("weather-details",Gi);var ko=J`
  :host {
    display: block;
  }
...
`;class ji extends M{constructor(){super(...arguments);this.forecast=[];this.clockFormat="24h"}static styles=ko;_cleanup=null;connectedCallback(){super.connectedCallback(),this.updateComplete.then(()=>{this._cleanup=eo(this.shadowRoot,".forecast-scroll")})}disconnectedCallback(){super.disconnectedCallback(),this._cleanup?.(),this._cleanup=null}getTemperature(o){return Math.round(o.temperature??o.temp??o.native_temperature??0)}render(){if(this.forecast.length===0)return u``;return u`
    ...
    `}}p([m({type:Object})],Vo.prototype,"hass",void 0),p([m({type:Object})],Vo.prototype,"config",void 0);class Uo extends M{constructor(){super(...arguments);this._config={}}setConfig(o){this._config={name:"",height:e.height,show_feels_like:e.showFeelsLike,show_wind:e.showWind,show_wind_gust:e.showWindGust,show_wind_direction:e.showWindDirection,show_humidity:e.showHumidity,show_min_temp:e.showMinTemp,show_hourly_forecast:e.showHourlyForecast,hourly_forecast_hours:e.hourlyForecastHours,show_daily_forecast:e.showDailyForecast,daily_forecast_days:e.dailyForecastDays,show_sunrise_sunset:e.showSunriseSunset,show_clock:e.showClock,clock_position:e.clockPosition,clock_format:e.clockFormat,overlay_opacity:e.overlayOpacity,language:e.language,wind_speed_unit:e.windSpeedUnit,sunrise_entity:"",sunset_entity:"",...o}}updated(o){if(super.updated(o),o.has("hass")){let i=I({hassLang:this.hass?.language});if(_.lang!==i)_.setLanguage(i),this.requestUpdate()}}get _schema(){return[{name:"entity",required:!0,selector:{entity:{domain:["weather"]}}},{name:"name",selector:{text:{}}},{name:"height",selector:{number:{min:200,max:800,step:10,mode:"box"}}},{name:"show_feels_like",selector:{boolean:{}}},{name:"show_wind",selector:{boolean:{}}},{name:"show_wind_gust",selector:{boolean:{}}},{name:"show_wind_direction",selector:{boolean:{}}},{name:"show_humidity",selector:{boolean:{}}},{name:"show_min_temp",selector:{boolean:{}}},{name:"show_hourly_forecast",selector:{boolean:{}}},{name:"hourly_forecast_hours",selector:{number:{min:1,max:24,step:1,mode:"box"}}},{name:"show_daily_forecast",selector:{boolean:{}}},{name:"daily_forecast_days",selector:{number:{min:1,max:14,step:1,mode:"box"}}},{name:"show_sunrise_sunset",selector:{boolean:{}}},{name:"sunrise_entity",selector:{entity:{domain:["sensor"]}}},{name:"sunset_entity",selector:{entity:{domain:["sensor"]}}},{name:"show_clock",selector:{boolean:{}}},{name:"clock_position",selector:{select:{options:[{label:_.t("editor.clock_position_top"),value:"top"},{label:_.t("editor.clock_position_details"),value:"details"}]}}},{name:"clock_format",selector:{select:{options:[{label:_.t("editor.clock_format_24h"),value:"24h"},{label:_.t("editor.clock_format_12h"),value:"12h"}]}}},{name:"overlay_opacity",selector:{number:{min:0,max:1,step:0.05,mode:"box"}}},{name:"language",selector:{select:{options:[{label:_.t("editor.language_auto"),value:"auto"},{label:_.t("editor.language_en"),value:"en"},{label:_.t("editor.language_ru"),value:"ru"},{label:_.t("editor.language_de"),value:"de"},{label:_.t("editor.language_nl"),value:"nl"},{label:_.t("editor.language_fr"),value:"fr"},{label:_.t("editor.language_es"),value:"es"},{label:_.t("editor.language_it"),value:"it"},{label:_.t("editor.language_sk"),value:"sk"},{label:_.t("editor.language_hu"),value:"hu"}]}}},{name:"wind_speed_unit",selector:{select:{options:[{label:_.t("editor.wind_speed_unit_ms"),value:"ms"},{label:_.t("editor.wind_speed_unit_kmh"),value:"kmh"}]}}}]}_computeLabel=(o)=>{let i=`editor.${o.name}`,a=_.t(i);return a===i?o.name:a};_valueChanged(o){let i=o.detail?.value;if(!i)return;this._config=i,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:this._config},bubbles:!0,composed:!0}))}render(){if(!this.hass)return u``;return u`
      ...
      ></ha-form>
    `}}p([m({attribute:!1})],Uo.prototype,"hass",void 0),p([go()],Uo.prototype,"_config",void 0);var Ti={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Vi=(o)=>(...i)=>({["_$litDirective$"]:o,values:i});class Ro{constructor(o){}get _$isConnected(){return this._$parent._$isConnected}_$initialize(o,i,a){this.__part=o,this._$parent=i,this.__attributeIndex=a}_$resolve(o,i){return this.update(o,i)}update(o,i){return this.render(...i)}}var Va=!0,rr=Va&&window.ShadyDOM?.inUse&&window.ShadyDOM?.noPatch===!0?window.ShadyDOM.wrap:(o)=>o;var Ui=(o)=>o.strings===void 0;var Ua=!0,io=(o,i)=>{let a=o._$disconnectableChildren;if(a===void 0)return!1;for(let n of a)n._$notifyDirectiveConnectionChanged?.(i,!1),io(n,i);return!0},uo=(o)=>{let i,a;do{if((i=o._$parent)===void 0)break;a=i._$disconnectableChildren,a.delete(o),o=i}while(a?.size===0)},Ri=(o)=>{for(let i;i=o._$parent;o=i){let a=i._$disconnectableChildren;if(a===void 0)i._$disconnectableChildren=a=new Set;else if(a.has(o))break;a.add(o),La(i)}};function Ra(o){if(this._$disconnectableChildren!==void 0)uo(this),this._$parent=o,Ri(this);else this._$parent=o}function Ya(o,i=!1,a=0){let n=this._$committedValue,l=this._$disconnectableChildren;if(l===void 0||l.size===0)return;if(i){if(Array.isArray(n))for(let s=a;s<n.length;s++)io(n[s],!1),uo(n[s]);else if(n!=null)io(n,!1),uo(n)}else io(this,o)}var La=(o)=>{if(o.type==Ti.CHILD)o._$notifyConnectionChanged??=Ya,o._$reparentDisconnectables??=Ra};class Yo extends Ro{constructor(){super(...arguments);this._$disconnectableChildren=void 0}_$initialize(o,i,a){super._$initialize(o,i,a),Ri(this),this.isConnected=o._$isConnected}["_$notifyDirectiveConnectionChanged"](o,i=!0){if(o!==this.isConnected)if(this.isConnected=o,o)this.reconnected?.();else this.disconnected?.();if(i)io(this,o),uo(this)}setValue(o){if(Ui(this.__part))this.__part._$setValue(o,this);else{if(Ua&&this.__attributeIndex===void 0)throw Error("Expected this.__attributeIndex to be a number");let i=[...this.__part._$committedValue];i[this.__attributeIndex]=o,this.__part._$setValue(i,this,0)}}disconnected(){}reconnected(){}}class Yi extends Yo{_key="";_onLangChange=null;render(o){return this._key=o,_.t(o)}reconnected(){this._onLangChange=()=>{this.setValue(_.t(this._key))},window.addEventListener("language-changed",this._onLangChange)}disconnected(){if(this._onLangChange)window.removeEventListener("language-changed",this._onLangChange)}}var Xa=Vi(Yi);try{customElements.define("dynamic-weather-card",Vo),customElements.define("dynamic-weather-card-editor",Uo),console.log(`%cDynamic Weather Card %c${Fi}`,"color: #007AFF; font-weight: bold; font-size: 14px;","color: #666; font-size: 12px;",`
