var p=function(o,i,a,n){var l=arguments.length,s=l<3?i:n===null?n=Object.getOwnPropertyDescriptor(i,a):n,r;if(typeof Reflect==="object"&&typeof Reflect.decorate==="function")s=Reflect.decorate(o,i,a,n);else for(var c=o.length-1;c>=0;c--)if(r=o[c])s=(l<3?r(s):l>3?r(i,a,s):r(i,a))||s;return l>3&&s&&Object.defineProperty(i,a,s),s};var io=globalThis,yo=io.ShadowRoot&&(io.ShadyCSS===void 0||io.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,fo=Symbol(),Lo=new WeakMap;class wo{constructor(o,i,a){if(this._$cssResult$=!0,a!==fo)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=o,this._strings=i}get styleSheet(){let o=this._styleSheet,i=this._strings;if(yo&&o===void 0){let a=i!==void 0&&i.length===1;if(a)o=Lo.get(i);if(o===void 0){if((this._styleSheet=o=new CSSStyleSheet).replaceSync(this.cssText),a)Lo.set(i,o)}}return o}toString(){return this.cssText}}var Ii=(o)=>{if(o._$cssResult$===!0)return o.cssText;else if(typeof o==="number")return o;else throw Error(`Value passed to 'css' function must be a 'css' function result: ${o}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},Oi=(o)=>new wo(typeof o==="string"?o:String(o),void 0,fo),W=(o,...i)=>{let a=o.length===1?o[0]:i.reduce((n,l,s)=>n+Ii(l)+o[s+1],o[0]);return new wo(a,o,fo)},Xo=(o,i)=>{if(yo)o.adoptedStyleSheets=i.map((a)=>a instanceof CSSStyleSheet?a:a.styleSheet);else for(let a of i){let n=document.createElement("style"),l=io.litNonce;if(l!==void 0)n.setAttribute("nonce",l);n.textContent=a.cssText,o.appendChild(n)}},Ei=(o)=>{let i="";for(let a of o.cssRules)i+=a.cssText;return Oi(i)},to=yo?(o)=>o:(o)=>o instanceof CSSStyleSheet?Ei(o):o;var{is:oa,defineProperty:ia,getOwnPropertyDescriptor:Io,getOwnPropertyNames:aa,getOwnPropertySymbols:na,getPrototypeOf:Oo}=Object,la=!1,H=globalThis;if(la)H.customElements??=customElements;var A=!0,v,Eo=H.trustedTypes,sa=Eo?Eo.emptyScript:"",ii=A?H.reactiveElementPolyfillSupportDevMode:H.reactiveElementPolyfillSupport;if(A)H.litIssuedWarnings??=new Set,v=(o,i)=>{if(i+=` See https://lit.dev/msg/${o} for more information.`,!H.litIssuedWarnings.has(i)&&!H.litIssuedWarnings.has(o))console.warn(i),H.litIssuedWarnings.add(i)},queueMicrotask(()=>{if(v("dev-mode","Lit is in dev mode. Not recommended for production!"),H.ShadyDOM?.inUse&&ii===void 0)v("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")});var ra=A?(o)=>{if(!H.emitLitDebugLogEvents)return;H.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))}:void 0,P=(o,i)=>o,j={toAttribute(o,i){switch(i){case Boolean:o=o?sa:null;break;case Object:case Array:o=o==null?o:JSON.stringify(o);break}return o},fromAttribute(o,i){let a=o;switch(i){case Boolean:a=o!==null;break;case Number:a=o===null?null:Number(o);break;case Object:case Array:try{a=JSON.parse(o)}catch(n){a=null}break}return a}},ao=(o,i)=>!oa(o,i),oi={attribute:!0,type:String,converter:j,reflect:!1,useDefault:!1,hasChanged:ao};Symbol.metadata??=Symbol("metadata");H.litPropertyMetadata??=new WeakMap;class b extends HTMLElement{static addInitializer(o){this.__prepare(),(this._initializers??=[]).push(o)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(o,i=oi){if(i.state)i.attribute=!1;if(this.__prepare(),this.prototype.hasOwnProperty(o))i=Object.create(i),i.wrapped=!0;if(this.elementProperties.set(o,i),!i.noAccessor){let a=A?Symbol.for(`${String(o)} (@property() cache)`):Symbol(),n=this.getPropertyDescriptor(o,a,i);if(n!==void 0)ia(this.prototype,o,n)}}static getPropertyDescriptor(o,i,a){let{get:n,set:l}=Io(this.prototype,o)??{get(){return this[i]},set(s){this[i]=s}};if(A&&n==null){if("value"in(Io(this.prototype,o)??{}))throw Error(`Field ${JSON.stringify(String(o))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);v("reactive-property-without-getter",`Field ${JSON.stringify(String(o))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get:n,set(s){let r=n?.call(this);l?.call(this,s),this.requestUpdate(o,r,a)},configurable:!0,enumerable:!0}}static getPropertyOptions(o){return this.elementProperties.get(o)??oi}static __prepare(){if(this.hasOwnProperty(P("elementProperties",this)))return;let o=Oo(this);if(o.finalize(),o._initializers!==void 0)this._initializers=[...o._initializers];this.elementProperties=new Map(o.elementProperties)}static finalize(){if(this.hasOwnProperty(P("finalized",this)))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(P("properties",this))){let i=this.properties,a=[...aa(i),...na(i)];for(let n of a)this.createProperty(n,i[n])}let o=this[Symbol.metadata];if(o!==null){let i=litPropertyMetadata.get(o);if(i!==void 0)for(let[a,n]of i)this.elementProperties.set(a,n)}this.__attributeToPropertyMap=new Map;for(let[i,a]of this.elementProperties){let n=this.__attributeNameForProperty(i,a);if(n!==void 0)this.__attributeToPropertyMap.set(n,i)}if(this.elementStyles=this.finalizeStyles(this.styles),A){if(this.hasOwnProperty("createProperty"))v("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators");if(this.hasOwnProperty("getPropertyDescriptor"))v("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}}static finalizeStyles(o){let i=[];if(Array.isArray(o)){let a=new Set(o.flat(1/0).reverse());for(let n of a)i.unshift(to(n))}else if(o!==void 0)i.push(to(o));return i}static __attributeNameForProperty(o,i){let a=i.attribute;return a===!1?void 0:typeof a==="string"?a:typeof o==="string"?o.toLowerCase():void 0}constructor(){super();this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){this.__updatePromise=new Promise((o)=>this.enableUpdating=o),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),this.constructor._initializers?.forEach((o)=>o(this))}addController(o){if((this.__controllers??=new Set).add(o),this.renderRoot!==void 0&&this.isConnected)o.hostConnected?.()}removeController(o){this.__controllers?.delete(o)}__saveInstanceProperties(){let o=new Map,i=this.constructor.elementProperties;for(let a of i.keys())if(this.hasOwnProperty(a))o.set(a,this[a]),delete this[a];if(o.size>0)this.__instanceProperties=o}createRenderRoot(){let o=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Xo(o,this.constructor.elementStyles),o}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this.__controllers?.forEach((o)=>o.hostConnected?.())}enableUpdating(o){}disconnectedCallback(){this.__controllers?.forEach((o)=>o.hostDisconnected?.())}attributeChangedCallback(o,i,a){this._$attributeToProperty(o,a)}__propertyToAttribute(o,i){let n=this.constructor.elementProperties.get(o),l=this.constructor.__attributeNameForProperty(o,n);if(l!==void 0&&n.reflect===!0){let r=(n.converter?.toAttribute!==void 0?n.converter:j).toAttribute(i,n.type);if(A&&this.constructor.enabledWarnings.includes("migration")&&r===void 0)v("undefined-attribute-value",`The attribute value for the ${o} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`);if(this.__reflectingProperty=o,r==null)this.removeAttribute(l);else this.setAttribute(l,r);this.__reflectingProperty=null}}_$attributeToProperty(o,i){let a=this.constructor,n=a.__attributeToPropertyMap.get(o);if(n!==void 0&&this.__reflectingProperty!==n){let l=a.getPropertyOptions(n),s=typeof l.converter==="function"?{fromAttribute:l.converter}:l.converter?.fromAttribute!==void 0?l.converter:j;this.__reflectingProperty=n;let r=s.fromAttribute(i,l.type);this[n]=r??this.__defaultValues?.get(n)??r,this.__reflectingProperty=null}}requestUpdate(o,i,a,n=!1,l){if(o!==void 0){if(A&&o instanceof Event)v("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()");let s=this.constructor;if(n===!1)l=this[o];if(a??=s.getPropertyOptions(o),(a.hasChanged??ao)(l,i)||a.useDefault&&a.reflect&&l===this.__defaultValues?.get(o)&&!this.hasAttribute(s.__attributeNameForProperty(o,a)))this._$changeProperty(o,i,a);else return}if(this.isUpdatePending===!1)this.__updatePromise=this.__enqueueUpdate()}_$changeProperty(o,i,{useDefault:a,reflect:n,wrapped:l},s){if(a&&!(this.__defaultValues??=new Map).has(o)){if(this.__defaultValues.set(o,s??i??this[o]),l!==!0||s!==void 0)return}if(!this._$changedProperties.has(o)){if(!this.hasUpdated&&!a)i=void 0;this._$changedProperties.set(o,i)}if(n===!0&&this.__reflectingProperty!==o)(this.__reflectingProperties??=new Set).add(o)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(i){Promise.reject(i)}let o=this.scheduleUpdate();if(o!=null)await o;return!this.isUpdatePending}scheduleUpdate(){let o=this.performUpdate();if(A&&this.constructor.enabledWarnings.includes("async-perform-update")&&typeof o?.then==="function")v("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`);return o}performUpdate(){if(!this.isUpdatePending)return;if(ra?.({kind:"update"}),!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),A){let l=[...this.constructor.elementProperties.keys()].filter((s)=>this.hasOwnProperty(s)&&(s in Oo(this)));if(l.length)throw Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${l.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(let[n,l]of this.__instanceProperties)this[n]=l;this.__instanceProperties=void 0}let a=this.constructor.elementProperties;if(a.size>0)for(let[n,l]of a){let{wrapped:s}=l,r=this[n];if(s===!0&&!this._$changedProperties.has(n)&&r!==void 0)this._$changeProperty(n,void 0,l,r)}}let o=!1,i=this._$changedProperties;try{if(o=this.shouldUpdate(i),o)this.willUpdate(i),this.__controllers?.forEach((a)=>a.hostUpdate?.()),this.update(i);else this.__markUpdated()}catch(a){throw o=!1,this.__markUpdated(),a}if(o)this._$didUpdate(i)}willUpdate(o){}_$didUpdate(o){if(this.__controllers?.forEach((i)=>i.hostUpdated?.()),!this.hasUpdated)this.hasUpdated=!0,this.firstUpdated(o);if(this.updated(o),A&&this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update"))v("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(o){return!0}update(o){this.__reflectingProperties&&=this.__reflectingProperties.forEach((i)=>this.__propertyToAttribute(i,this[i])),this.__markUpdated()}updated(o){}firstUpdated(o){}}b.elementStyles=[];b.shadowRootOptions={mode:"open"};b[P("elementProperties",b)]=new Map;b[P("finalized",b)]=new Map;ii?.({ReactiveElement:b});if(A){b.enabledWarnings=["change-in-update","async-perform-update"];let o=function(i){if(!i.hasOwnProperty(P("enabledWarnings",i)))i.enabledWarnings=i.enabledWarnings.slice()};b.enableWarning=function(i){if(o(this),!this.enabledWarnings.includes(i))this.enabledWarnings.push(i)},b.disableWarning=function(i){o(this);let a=this.enabledWarnings.indexOf(i);if(a>=0)this.enabledWarnings.splice(a,1)}}(H.reactiveElementVersions??=[]).push("2.1.2");if(A&&H.reactiveElementVersions.length>1)queueMicrotask(()=>{v("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.")});var K=globalThis,u=(o)=>{if(!K.emitLitDebugLogEvents)return;K.dispatchEvent(new CustomEvent("lit-debug",{detail:o}))},ca=0,V;K.litIssuedWarnings??=new Set,V=(o,i)=>{if(i+=o?` See https://lit.dev/msg/${o} for more information.`:"",!K.litIssuedWarnings.has(i)&&!K.litIssuedWarnings.has(o))console.warn(i),K.litIssuedWarnings.add(i)},queueMicrotask(()=>{V("dev-mode","Lit is in dev mode. Not recommended for production!")});var N=K.ShadyDOM?.inUse&&K.ShadyDOM?.noPatch===!0?K.ShadyDOM.wrap:(o)=>o,no=K.trustedTypes,ai=no?no.createPolicy("lit-html",{createHTML:(o)=>o}):void 0,da=(o)=>o,co=(o,i,a)=>da,_a=(o)=>{if(C!==co)throw Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");C=o},ga=()=>{C=co},zo=(o,i,a)=>{return C(o,i,a)},_i="$lit$",q=`lit$${Math.random().toFixed(9).slice(2)}$`,gi="?"+q,ha=`<${gi}>`,$=document,U=()=>$.createComment(""),R=(o)=>o===null||typeof o!="object"&&typeof o!="function",Ho=Array.isArray,ea=(o)=>Ho(o)||typeof o?.[Symbol.iterator]==="function",po=`[ 	
\f\r]`,ka=`[^ 	
\f\r"'\`<>=]`,ua=`[^\\s"'>=/]`,D=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,ni=1,mo=2,ya=3,li=/-->/g,si=/>/g,x=new RegExp(`>|${po}(?:(${ua}+)(${po}*=${po}*(?:${ka}|("|')|))|$)`,"g"),fa=0,ri=1,wa=2,ci=3,Fo=/'/g,Mo=/"/g,hi=/^(?:script|style|textarea|title)$/i,ta=1,lo=2,so=3,Ao=1,ro=2,pa=3,ma=4,Fa=5,bo=6,Ma=7,Ko=(o)=>(i,...a)=>{if(i.some((n)=>n===void 0))console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},k=Ko(ta),f=Ko(lo),nn=Ko(so),Q=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),di=new WeakMap,B=$.createTreeWalker($,129),C=co;function ei(o,i){if(!Ho(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
...
`,Ta={sunny:f`
  ...
  `};function E(o,...i){let a=Da[o];if(typeof a==="function")return a(...i);return a||""}function eo(o){if(!o)return"";return Ta[o.toLowerCase()]||""}class Gi extends M{constructor(){super(...arguments);this.weather=null;this.sunData=null;this.config=null;this.entityAttributes=null}static styles=W`
    :host {
      display: block;
    }
  ...
  `;hasContent(){if(!this.weather||!this.config)return!1;return this.config.showHumidity&&this.weather.humidity!=null||this.config.showWind&&this.weather.windSpeed!=null||this.config.showSunriseSunset&&this.sunData?.hasSunData===!0}renderHumidity(){if(!this.config?.showHumidity||this.weather?.humidity==null)return k``;return k`
    ...
    `}renderWind(){if(!this.config?.showWind||this.weather?.windSpeed==null)return k``;let o=this.entityAttributes||{},i=Jo(this.weather.windSpeed,o,this.config.windSpeedUnit),a=Bi(o,this.config.windSpeedUnit,_.t.bind(_)),n="";if(this.config.showWindGust&&this.weather.windGust)n=` / ${Jo(this.weather.windGust,o,this.config.windSpeedUnit)} ${a}`;let l=this.config.showWindDirection&&this.weather.windBearing!=null?Pi(this.weather.windBearing):E("wind");return k`
      <div class="info-item">
    ...
    `}}p([m({type:Object})],Gi.prototype,"weather",void 0),p([m({type:Object})],Gi.prototype,"sunData",void 0),p([m({type:Object})],Gi.prototype,"config",void 0),p([m({type:Object})],Gi.prototype,"entityAttributes",void 0);customElements.define("weather-details",Gi);var ko=W`
  :host {
    display: block;
  }
        ...
        <div class="forecast-scroll">
          ${this.forecast.map((o)=>k`
            <div class="forecast-item">
              <div class="forecast-time">${xi(o.datetime,this.clockFormat,_.t("am"),_.t("pm"))}</div>
              ...
              <div class="primary-left">
                ...
                ${this.config.showMinTemp?k`
                  <div class="temp-range">
                    <span class="temp-min">↓ ${o.templow!=null?`${Math.round(o.templow)}°`:_.t("no_data")}</span>
                  </div>
                `:""}
