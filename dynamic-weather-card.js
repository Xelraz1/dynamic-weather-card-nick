...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`);return{["_$litType$"]:o,strings:i,values:a}},u=Ko(ta),f=Ko(lo),nn=Ko(so),Q=Symbol.for("lit-noChange"),F=Symbol.for("lit-nothing"),di=new WeakMap,B=$.createTreeWalker($,129),C=co;function ei(o,i){if(!bo(o)||!o.hasOwnProperty("raw")){let a="invalid template strings array";throw a=`
        ...
        <div class="forecast-scroll">
          ${this.forecast.map((o)=>{let i=this.getPrecipitation(o),a=o.condition||"sunny",n=o.severerisk;if(n!=null&&n>20)a="lightning-rainy";let l=this.getHighTemp(o),s=this.getLowTemp(o);return u`
              <div class="forecast-item">
                ...
                <div class="forecast-icon">${eo(a)}</div>
                ${i!=null&&i>0?u`
